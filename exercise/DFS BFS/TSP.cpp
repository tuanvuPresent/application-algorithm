...
from point i to point j(i,j=0,1,�,n), help that person to compute the shortest
route.

Input
Line 1 contains n(1<=n<=15) Line i+1(i=1,2,�,n+1) contains the ithith line of
the matrix c Output Unique line contains the length of the shortest route input:
9
